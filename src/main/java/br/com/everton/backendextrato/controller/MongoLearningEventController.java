...
import br.com.everton.backendextrato.service.MongoLearningEventService;
...
@RestController
@RequestMapping("/api/mongo-learning/events")
public class MongoLearningEventController {

    private final MongoLearningEventService service;
    private final AuthenticatedUserResolver authenticatedUserResolver;
    private final AccessControlService accessControlService;

    public MongoLearningEventController(
            MongoLearningEventService service,
    ...
    public ResponseEntity<?> create(
            @RequestBody MongoLearningEventRequest request,
