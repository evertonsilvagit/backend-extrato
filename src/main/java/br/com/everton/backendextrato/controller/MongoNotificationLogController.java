...
import br.com.everton.backendextrato.service.MongoNotificationLogService;
...
@RestController
@RequestMapping("/api/mongo-notifications/logs")
public class MongoNotificationLogController {

    private final MongoNotificationLogService service;
    private final AuthenticatedUserResolver authenticatedUserResolver;
    private final AccessControlService accessControlService;

    public MongoNotificationLogController(
            MongoNotificationLogService service,
